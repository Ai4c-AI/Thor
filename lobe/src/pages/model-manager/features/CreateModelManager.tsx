                ...
                <DialogHeader className="space-y-4 pb-6">
                    <div className="flex items-center justify-between">
                        <div className="flex items-center gap-3">
                            <div className="p-3 rounded-2xl bg-gradient-to-br from-primary/20 to-primary/5 ring-2 ring-primary/10">
                                                ...
                                                <CardContent className="px-0 space-y-8">
                                                    ...
                                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                                                        ...
                                                        <FormField
                                                            ...
                                                            name="isVersion2"
                                                            render={({ field }) => (
                                                                <FormItem className="flex flex-row items-center justify-between rounded-xl border-2 border-dashed p-6 hover:border-primary/50 transition-colors">
